...
namespace Badass.Tests
{
    public class TestUtil
    {
        ...
        public static Domain CreateTestDomain(IFileSystem fs)
        {
            ...
            var userType = new ApplicationType("user", TestNamespace);
            var userIdField = new Field(userType) { Name = "id", ClrType = typeof(int), ProviderTypeName = "integer", IsIdentity = true, IsRequired = true };
            ...
            var customerType = new ApplicationType("customer", TestNamespace);
            var customerIdField = new Field(customerType) { Name = "id", ClrType = typeof(int), IsIdentity = true, ProviderTypeName = "integer", IsRequired = true };
            ...
            var orderType = new ApplicationType("order", TestNamespace);
            var orderIdField = new Field(orderType){Name = "id", ClrType = typeof(System.Guid), ProviderTypeName = "uuid", IsIdentity = true, IsRequired = true};
            ...
            var orderLineType = new ApplicationType("order_line", TestNamespace);
            var orderLineIdField = new Field(orderLineType){Name = "id", ClrType = typeof(System.Guid), ProviderTypeName = "uuid", IsIdentity = true, IsRequired = true};
            orderLineType.Fields.Add(orderLineIdField);
            orderLineType.Fields.Add(new Field(orderLineType){Name = "description", ClrType = typeof(string), IsRequired = false, IsIdentity = false, ProviderTypeName = "text"});
